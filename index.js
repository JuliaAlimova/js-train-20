...
myTruck.specific(20000);

// Додаємо метод drive для прототипу Car, який збільшує mileage на передане число, та виводить Подорожуємо <mileage> кілометрів у <brand> <model>.
...
const boundDrive = car.drive.bind(car, 100);
boundDrive();
